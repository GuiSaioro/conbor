...
function modalvariado(a){
	...
	if(CookieSetado == undefined){
		...
		buttonmodal.addEventListener('click',function(){
			...
			//let arquivocookie = document.querySelector('#btnModal').value;
			Cookies.set('Nome', nomecookie , {expires: 365} );
			Cookies.set('E-mail', emailcookie , {expires: 365} );
			//Cookies.set('Arquivo', arquivocookie);
		...
		if(arquivocookie == "0"){	arquivo.value = "catalogo-acoplamentos-conbor"};
		if(arquivocookie == "1"){	arquivo.value = "catalogo-embreagense-freios-conbor"};
		if(arquivocookie == "2"){	arquivo.value = "catalogo-pecas-tecnicas-conbor"};
		if(arquivocookie == "3"){	arquivo.value = "certificado_ISO_9001-2015-IQNet"};
		if(arquivocookie == "4"){	arquivo.value = "Certificado_ISO-9001-2015-RINA"};
		if(arquivocookie == "5"){	arquivo.value = "CRCC_Petrobras-24-11-20"};
		if(arquivocookie == "6"){	arquivo.value = "manual_EI-conbor"};
		if(arquivocookie == "7"){	arquivo.value = "manual_IV-conbor"};
		if(arquivocookie == "8"){	arquivo.value = "tabela-de-acoplamentos-conbor"};
		if(arquivocookie == "9"){	arquivo.value = "tabela-de-acoplamentos-fg-conbor"};
		if(arquivocookie == "10"){	arquivo.value = "tabela-de-acoplamentos-fi-conbor"};
		if(arquivocookie == "11"){	arquivo.value = "tabela-de-acoplamentos-standart-conbor"};
		if(arquivocookie == "12"){	arquivo.value = "tabela-de-equivalencia-dos-acoplamentos-conbor"};
		if(arquivocookie == "13"){	arquivo.value = "tabela-de-medidas-de-elementos-pneumaticos-conbor"};
		if(arquivocookie == "14"){	arquivo.value = "certificado_ISO_9001-2015-IQNet"};
		if(arquivocookie == "15"){	arquivo.value = "Certificado_ISO-9001-2015-RINA"};
		if(arquivocookie == "16"){	arquivo.value = "tabela-de-medidas-de-elementos-pneumaticos-conbor"};
	
		Cookies.set('Arquivo', arquivocookie);
		nome.value = Cookies.get('Nome');
		email.value = Cookies.get('E-mail');
		//arquivo.value = Cookies.get('Arquivo')
